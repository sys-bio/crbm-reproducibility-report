...
\rfoot{\thepage}
\lfoot{\tiny\bfseries CRBM Reproducibility Report version 1.3}
...
\begin{todolist}
  ...
  \begin{todolist}
    %\item[\VAR{_er[26]}] Proprietary license provided
    %\item[\VAR{_er[27]}] Permissive license provided
    %\item[\VAR{_er[28]}] Open-source license provided
	\item[\VAR{_er[28]}] License provided
		\item[\VAR{_er[999]}] License is Open Source Initiative (OSI)-approved 
  \end{todolist}
...
title= \textbf{Box 3:} Rules for Credible practice of
 Modeling and Simulation\footnote{Model credibility is assessed using the Interagency Modeling and Analysis Group conformance rubric:\\ \href{https://www.imagwiki.nibib.nih.gov/content/10-simple-rules-conformance-rubric}{https://www.imagwiki.nibib.nih.gov/content/10-simple-rules-conformance-rubric}}]
\begin{todolist}
    \item[
...
\bigskip
\noindent
\VAR{curator_name}\footnotemark, \VAR{curator_degree}
\\
